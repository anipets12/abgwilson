...
const Comercial = () => {
    ...
    return (_jsx(ServiceLayout, { title: "Comercial", icon: _jsx(FaBuilding, { className: "mr-2 text-yellow-400" }), description: "Asesor\u00EDa legal especializada para empresas, emprendedores y comerciantes. Soluciones personalizadas para proteger sus intereses comerciales y potenciar su negocio.", services: servicios, successCases: casosExito, specialties: especialidades, whatsappText: "Hola Abg. Wilson, necesito asesor\u00EDa en derecho comercial." }));
};
