    ...
    <AnimatePresence>
      {message && (
        <motion.div
          ...
          className={`rounded-md ${config.bgColor} p-4 border ${config.borderColor} mb-4`}
        >
          <div className="flex">
            ...
            {onClose && (
              <div className="ml-auto pl-3">
                <div className="-mx-1.5 -my-1.5">
                  <button
                    onClick={onClose}
                    className={`inline-flex rounded-md p-1.5 ${config.bgColor} ${config.textColor} hover:bg-opacity-80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-${type}-50 focus:ring-${type}-600`}
                  >
