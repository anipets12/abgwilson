...
const Penal = () => {
    ...
    return (_jsx(ServiceLayout, { title: "Penal", icon: _jsx(FaBalanceScale, { className: "mr-2 text-yellow-400" }), description: "Defensa legal especializada para proteger sus derechos y libertades en procedimientos penales. M\u00E1s de 15 a\u00F1os de experiencia defendiendo casos complejos con resultados probados.", services: servicios, successCases: casosExito, specialties: especialidades, whatsappText: "Hola Abg. Wilson, necesito asesor\u00EDa en derecho penal." }));
};
